            ...
            <div class="row py-5 d-flex align-items-center justify-content-center">
                ...
                <div class="col-md-3" data-aos="zoom-in" data-aos-duration="2000">
                    <ul class="contactList">
                        <li class="my-5"><img class="mr-3" src="<?php echo base_url('assets/img/iconos/El-careyes-mail-info.svg')?>" alt=""><a href="#"><?php echo lang('sectionContactemail') ?></a></li>
                        <li class="my-5"><img class="mr-3" src="<?php echo base_url('assets/img/iconos/El-careyes-phone-info.svg')?>" alt=""><a href="#"><?php echo lang('sectionContacttel') ?></a></li>
                        <li class="my-5"><img src="<?php echo base_url('assets/img/iconos/El-careyes-maps-info.svg')?>" alt="" class="mr-3 "><a href="#"><?php echo lang('sectionContactMaps') ?></a></li>
