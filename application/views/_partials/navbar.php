<section class="d-none d-md-block">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto textnav">
      ...
      <li class="nav-item ml-4">
        <a class=" textnav <?php echo item_menu_active('reservation');?>" href="<?php echo  base_url() ?><?php echo $language; ?>/reservation" class="nav-link"><?php echo lang('reservations')?></a>
      </li>
      <li class="nav-item ml-4">
        <a class=" textnav <?php echo item_menu_active('realestate');?>" href="<?php echo  base_url() ?><?php echo $language; ?>/realestate" class="nav-link "><?php echo lang('real_estate')?></a>
      </li>
      <li class="nav-item ml-4">
      ...
      <li class="nav-item ml-4">
        <a class=" textnav <?php echo item_menu_active('contact');?>" href="<?php echo  base_url() ?><?php echo $language; ?>/contact" class="nav-link"><?php echo lang('contact')?></a>
      </li>
    </ul>
...
<section class="d-block d-md-none">
    <div class="fixed-top shadow" id="mainMenuMobile">
      <img src="<?php echo base_url('assets/img/logo.svg') ?>" alt="" class="img-fluid py-4 pl-4 w-50">
      ...
      <div class="menu-items position-fixed">
        ...
        <div class="col-md-12 d-flex justify-content-center mt-5">
          <a class="mx-3" target="_blank" href="https://www.instagram.com/elcareyes_clubandresidences/">
            <img class="w-100 img-fluid" src="<?php echo base_url('assets/img/iconos/instagram.png') ?>">
          </a>
          <a href="#" class="mx-3">
            <img class="w-100 img-fluid" src="<?php echo base_url('assets/img/iconos/twitter.png') ?>">
          </a>
          <a href="#" class="mx-3">
            <img class="w-100 img-fluid" src="<?php echo base_url('assets/img/iconos/whatsapp.png') ?>">
          </a>
          <a class="mx-3" target="_blank" href="https://www.facebook.com/pages/category/Local-Business/El-Careyes-Club-Residences-1261260937307887/">
            <img class="w-100 img-fluid" src="<?php echo base_url('assets/img/iconos/facebook.png') ?>">
          </a>
        </div>
      </div>
    </div>
