				...
				<div id="carouselHome" class="carousel slide" data-ride="carousel" data-interval="7000">
					<div class="carousel-inner">
						<div class="carousel-item active">
							...
							<img src="<?php echo base_url('assets/img/Home/El-Careyes-club-and-residences-bg1.jpg') ?>" class="d-block w-100 " alt="..." >
						</div>
						<div class="carousel-item">
							<div class="container-fluid" data-slide="next">
								<div class="row">
								...
								<img src="<?php echo base_url('assets/img/Home/El-Careyes-club-and-residences-bg2.jpg') ?>" class="d-block w-100 " alt="...">
						</div>
						<div class="carousel-item">
							<div class="container-fluid" data-slide="next">
								<div class="row">
								...
								<img src="<?php echo base_url('assets/img/Home/El-Careyes-club-and-residences-bg3.jpg') ?>" class="d-block w-100 " alt="...">
						</div>
						<div class="carousel-item">
							<div class="container-fluid" data-slide="next">
								<div class="row">
								...
								<img src="<?php echo base_url('assets/img/Home/El-Careyes-club-and-residences-bg4.jpg') ?>" class="d-block w-100" alt="...">
						</div>
						...
						<div class="carousel-item">
							...
							<img src="<?php echo base_url('assets/img/Home/El-Careyes-club-and-residences-bg5.jpg') ?>" class="d-block w-100 " alt="...">
						</div>
						...
						<div class="carousel-item">
							...
							<img src="<?php echo base_url('assets/img/Home/El-Careyes-club-and-residences-bg6.jpg') ?>" class="d-block w-100 " alt="...">
						</div>
						...
						<div class="carousel-item">
							...
							<img src="<?php echo base_url('assets/img/Home/El-Careyes-club-and-residences-bg7.jpg') ?>" class="d-block w-100 " alt="...">
						</div>
					</div>
					<a class="carousel-control-prev indication indicationPrev" href="#carouselHome" role="button" data-slide="prev">
						<img  aria-hidden="true" src="<?php echo base_url('assets/img/iconos/El-Careyes-Icon-arrow-left.svg')?>">
						<span class="sr-only mr-1"><?php echo lang('previous') ?></span>
					</a>
					<a class="carousel-control-next indication indicationNext" href="#carouselHome" role="button" data-slide="next">
						<img  aria-hidden="true" src="<?php echo base_url('assets/img/iconos/El-Careyes-Icon-arrow-rigth.svg')?>">
				...
				<div id="carouselHomeMobile" class="carousel slide" data-ride="carousel" data-interval="7000">
					<div class="carousel-inner">
						<div class="carousel-item active">
							...
							<img src="<?php echo base_url('assets/img/Home/El-Careyes-club-and-residences-bg-m.jpg') ?>" class="d-block w-100 " alt="..." >
						</div>
						<div class="carousel-item">
							<div class="container-fluid" data-slide="next">
								<div class="row">
							...
							<img src="<?php echo base_url('assets/img/Home/El-Careyes-club-and-residences-bg2-m.jpg') ?>" class="d-block w-100 " alt="...">
						</div>
						<div class="carousel-item">
							<div class="container-fluid" data-slide="next">
								<div class="row">
							...
							<img src="<?php echo base_url('assets/img/Home/El-Careyes-club-and-residences-bg3-m.jpg') ?>" class="d-block w-100 " alt="...">
						</div>
						<div class="carousel-item">
							<div class="container-fluid" data-slide="next">
								<div class="row">
							...
							<img src="<?php echo base_url('assets/img/Home/El-Careyes-club-and-residences-bg4-m.jpg') ?>" class="d-block w-100 " alt="...">
						</div>
						<div class="carousel-item">
							<div class="container-fluid" data-slide="next">
								<div class="row">
							...
							<img src="<?php echo base_url('assets/img/Home/El-Careyes-club-and-residences-bg5-m.jpg') ?>" class="d-block w-100" alt="...">
						</div>
						<div class="carousel-item">
							<div class="container-fluid" data-slide="next">
								<div class="row">
							...
							<img src="<?php echo base_url('assets/img/Home/El-Careyes-club-and-residences-bg6-m.jpg') ?>" class="d-block w-100" alt="...">
						</div>
						<div class="carousel-item">
							<div class="container-fluid" data-slide="next">
								<div class="row">
							...
							<img src="<?php echo base_url('assets/img/Home/El-Careyes-club-and-residences-bg7-m.jpg') ?>" class="d-block w-100" alt="...">
						</div>

					</div>
					<a class="carousel-control-prev indLeftMainSlider indication indicationPrev" href="#carouselHomeMobile" role="button" data-slide="prev" >
						<img class="w-100 img-fluid" aria-hidden="true" src="<?php echo base_url('assets/img/iconos/El-Careyes-Icon-arrow-left.svg')?>">
						<span class="sr-only mr-1"><?php echo lang('previous') ?></span>
					</a>
					<a class="carousel-control-next indLeftMainSlider indication indicationNext" href="#carouselHomeMobile" role="button" data-slide="next" >
						<img class="w-100 img-fluid" aria-hidden="true" src="<?php echo base_url('assets/img/iconos/El-Careyes-Icon-arrow-rigth.svg')?>">
						<span class="sr-only"><?php echo lang('next') ?></span>
					</a>
				</div>
			</div>
...
<div class="container-fluid">
		<div class="slideprogress">
			<div id="home-about-section" class="mt-5 primaryCont">
						...
						<div class="container">
							<div class="row fondo-home-about-section mt-5 pt-5">
								<div class="col-md-6 mt-5 d-flex justify-content-center">
									<div class="mt-4">
										<h2 class="letter"><?php echo lang('titleAboutCareyesBar') ?></h2>
									</div>
								</div>
								<div class="col-md-6 text-justify my-3 pt-2">
									<div class="mt-2">
									<p><?php echo lang('paragraphAboutCareyesBar') ?></p>
									</div>
								</div>                   
							</div>
						</div>
					...
					<div class="item">
							...
							<div class="row">
								<div class="col-md-4 imageBar mt-3">
									...
									<div class="home-stages-section-text p-3">
										...
										<p class="text-left d-none d-md-block"><?php echo lang('aboutAccessBar') ?></p>
									</div>
								</div>
								<div class="col-md-4 imageBar mt-3">
									<img src="<?php echo base_url('assets/img/Home/El-Careyes-club-and-residence-food-area.jpg') ?>" class="img-fluid w-100" alt="">
									<div class="home-stages-section-text p-3">
										<h4 class="textMark"><?php echo lang('TitleaboutFoodBar') ?></h4>							
										<p class="text-left d-none d-md-block"><?php echo lang('aboutFoodBar') ?></p>
									</div>
								</div>
								<div class="col-md-4 imageBar mt-3">
									...
									<div class="home-stages-section-text p-3">
										...
										<p class="text-left d-none d-md-block"><?php echo lang('aboutPicnicBar') ?></p>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="item">
							<div id="booking-information">
								<div class="container">
									<div class="row text-center mx-auto my-5 pt-5 fondo-home-stages-section">
	...
	<div class="row position-absolute iconHand">
		<div class="col-md-12">
...
<div class="container barP mt-4">
    <div class="text-center">
        <div class="progress" style="height: 5px; background: transparent;">
            <div class="barra-progreso progress-bar porcentaje-treinta barPr" role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
        </div>
    </div>
</div>
<section>
